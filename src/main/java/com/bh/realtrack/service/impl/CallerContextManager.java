...
public class CallerContextManager implements ICallerContextManager {
    ...
    protected final static String APPLICATION_KEY_HEADER = "ApplicationKey";
    ...
    public CallerContext getCallerContext(HttpServletRequest request) {
        ...
        if(authentication instanceof OAuth2Authentication){
            ...
            return new CallerContext(oauth.getName(), request.getHeader(APPLICATION_KEY_HEADER), oauth.getAuthorities());

        }
        throw new UnknowAuthenticationException("Unsupported authentication object: "+authentication.getClass().getName());
    }*/
